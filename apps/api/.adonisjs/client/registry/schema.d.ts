...
export interface Registry {
  ...
  'serverConfig.server_config.show': {
    ...
    types: {
      ...
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/server_config_controller').default['show']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/server_config_controller').default['show']>>>
    }
  }
  'serverConfig.server_config.update': {
    ...
    pattern: '/api/v1/server-config'
    types: {
      body: ExtractBody<InferInput<(typeof import('#validators/server_config').updateServerConfigValidator)>>
      paramsTuple: []
      params: {}
      query: ExtractQuery<InferInput<(typeof import('#validators/server_config').updateServerConfigValidator)>>
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/server_config_controller').default['update']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/server_config_controller').default['update']>>> | { status: 422; response: { errors: SimpleError[] } }
    }
  }
