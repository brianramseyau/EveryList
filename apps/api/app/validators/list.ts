...
export const createListValidator = vine.create({
  ...
  useCategoryLearning: vine.boolean().optional(),
  ...
  useDeadline: vine.boolean().optional(),
  useSubtasks: vine.boolean().optional(),
  useSubtaskAutoComplete: vine.boolean().optional(),
  showStoreInList: vine.boolean().optional(),
  showPriceInList: vine.boolean().optional(),
  itemSortOrder: vine.enum(['ranked', 'alphabetical', 'deadline'] as const).optional(),
